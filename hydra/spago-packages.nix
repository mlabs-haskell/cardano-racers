...
let
  inputs = {
    ...
    "cardano-data-lite" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "2ccb31011e2e00c94aac6303dff3f16087560adb";
          sha256 = "1n4aj42yjlyi54pl8qvw3k4qv7nxqjb4iad6c7q04f3jjb1kcnij";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
  ...
  # cardano-racers-offchain is a Local package in (Local "./../offchain")
