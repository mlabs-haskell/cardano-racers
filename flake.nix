{
  inputs = {
    plutip.url = github:mlabs-haskell/plutip?ref=gergely/version-bump;
    cardano-transaction-lib.url = github:Plutonomicon/cardano-transaction-lib/2c8e8fb75c6820e51b955ce3f7e2f5ac2446822e;
