{
  description = "cardano-racers-offchain";
  ...
  inputs = {
    ...
    ctl = {
      ...
      rev = "d7b5de6a0e6077d3fd0d834b7c4a4214a324d49e";
    };
  ...
  outputs = { self, nixpkgs, ctl, ... }:
    let
      ...
      # that takes a single argument. Alternatively, you can pass an attrset
      # directly.
      #
